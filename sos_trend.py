...
lon = ds.lon
time = ds.time
var = ds[variable] #is it reasonable to do the trend on the logarithm (of the night??)
...
trend_matrix.to_netcdf(surf_path+'/Results/'+'trend_sos_ORCA-0.25x0.25_regular_1979_2018.nc')
trend_pvalue.to_netcdf(surf_path+'/Results/'+'pvalue_sos_ORCA-0.25x0.25_regular_1979_2018.nc')
